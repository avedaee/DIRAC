...
def getFTS():
  '''
    Gets all storage elements from /Resources/FTSEndpoints/FTS3/
  '''

  # we are considering only the FTS3 endpoints 
  _basePath = 'Resources/FTSEndpoints/FTS3/'

  ftsEndpoints = gConfig.getSections( _basePath )

  return ftsEndpoints

def getFTSurl( ftsServer ):

  _basePath = 'Resources/FTSEndpoints/FTS3/'
  url = gConfig.getOptionsDict( _basePath + ftsServer )
